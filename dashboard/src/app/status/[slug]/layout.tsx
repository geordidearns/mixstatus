...
export default async function ServiceLayout({
	...
	return (
		<div className="relative">
			<div className="absolute inset-x-0 h-28 sm:h-32 md:h-36 lg:h-40 bg-[radial-gradient(var(--dot-color)_1px,transparent_1px)] [background-size:16px_16px] border-b border-border">
